...
DIMLIST="
qJ|zeros(${parallel_NQJ_leg},${parallel_NLEGS})
xP|zeros(${parallel_NX},1)
xDP|zeros(${parallel_NX},1)
xDDP|zeros(${parallel_NX},1)
koppelP|zeros(${parallel_NLEGS},3)
legFrame|zeros(${parallel_NLEGS},3)
g|zeros(3,1)
r_base|zeros(3,1)
phi_base|zeros(3,1)
V_base|zeros(6,1)
