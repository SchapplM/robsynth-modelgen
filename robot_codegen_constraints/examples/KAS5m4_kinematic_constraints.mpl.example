...
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_delta8.m", robot_name):
...
save kintmp_qs, kintmp_qt, kin_constraints_exist, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_inert", robot_name):
save kintmp_qs, kintmp_qt, kin_constraints_exist, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_inert.m", robot_name):
