...
# 
# Eingabe:
# "../codeexport/KAS5_m3_definitions"
# * enthält die Definitionen aller Konstanten und verallgemeinerter Koordinaten
# 
# Ausgabe:
# "../codeexport/%s/kinematic_constraints_maple_inert.m"
...
save r_4_G5_B, "../codeexport/KAS5_m3_kinematic_constraints_r_4_G5_B_debug_maple":
...
save r_4_G5_D, "../codeexport/KAS5_m3_kinematic_constraints_r_4_G5_D_noopt_debug_maple":
if Schalter_Opt(7) = 1 then
  r_4_G5_D := simplify(r_4_G5_D, trig):
  r_4_G5_D := simplify(r_4_G5_D):
  r_4_G5_D := combine(r_4_G5_D, trig):
end if:
save r_4_G5_D, "../codeexport/KAS5_m3_kinematic_constraints_r_4_G5_D_opt_debug_maple":
...
save r_3_D_C, "../codeexport/KAS5_m3_kinematic_constraints_r_3_D_C_debug_noopt_maple":
if Schalter_Opt(6) = 1 then
  r_3_D_C := simplify(r_3_D_C, trig):
  r_3_D_C := simplify(r_3_D_C):
  r_3_D_C := combine(r_3_D_C, trig):
end if:
save r_3_D_C, "../codeexport/KAS5_m3_kinematic_constraints_r_3_D_C_debug_opt_maple":
# Gl. (m3.5)
...
save r_3_D_E, sprintf("../codeexport/%s/kinematic_constraints_r_3_D_E_noopt_debug_maple", robot_name):
if Schalter_Opt(5) = 1 then
  r_3_D_E := simplify(r_3_D_E, trig):
  r_3_D_E := simplify(r_3_D_E):
  r_3_D_E := combine(r_3_D_E, trig):
end if:
save r_3_D_E, sprintf("../codeexport/%s/kinematic_constraints_r_3_D_E_opt_debug_maple", robot_name):
...
save r_3_D_F, sprintf("../codeexport/%s/kinematic_constraints_r_3_D_F_noopt_debug_maple", robot_name):
...
printf("CPU-Zeit bis hier: %1.2fs\n", time()-st):
save r_3_D_F, sprintf("../codeexport/%s/kinematic_constraints_r_3_D_F_opt_debug_maple", robot_name):
save ReturnValue, r_3_D_F, r_3_F_G3, sprintf("../codeexport/%s/kinematic_constraints_gamma3_qs_debug_maple", robot_name):
# Gl. (m3.6)
...
save ReturnValue, r_3_D_F, r_3_F_G3, gamma3_qs, sprintf("../codeexport/%s/kinematic_constraints_gamma3_qs_debug_maple", robot_name):
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_gamma3.m", robot_name):
...
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_beta2.m", robot_name):
# Berechne delta3
# Gl. (m3.9)
# Siehe auch: KAS5_m3_sym_codegen_kinematic_constraints_hilfsberechnungen.mw
...
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_delta3.m", robot_name):
# Berechne rho3
# Gl. (11)
...
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_rho3.m", robot_name):
...
save kintmp_qs, kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_maple_debug_nach_delta6.m", robot_name):
# Kompensationsfeder
...
save kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_kintmp_subsexp_maple", robot_name):
save kintmp_subsexp, sprintf("../codeexport/%s/kinematic_constraints_kintmp_subsexp_maple.m", robot_name):
printf("Ausdrücke für kintmp_subsexp gespeichert (Maple). %s. CPU-Zeit bis hier: %1.2fs.\n", FormatTime("%Y-%m-%d %H:%M:%S"), time()-st):
for i from 1 to RowDimension(kintmp_s) do
  tmp := kintmp_qs(i):
  save tmp, sprintf("../codeexport/%s/kinematic_constraints_maple_inert_kintmpq_%d", robot_name, i):
  save tmp, sprintf("../codeexport/%s/kinematic_constraints_maple_inert_kintmpq_%d.m", robot_name, i):
end do:
...
save kintmp_qs, sprintf("../codeexport/%s/kinematic_constraints_kintmp_qs_maple_inert", robot_name):
