...
sed -i "/% %INPUT_XPD%/r $tmp_head_pfad/robot_matlabtmp_comment_input_xPD.m" $mfcndat
sed -i "/%INPUT_XPD%/d" $mfcndat
sed -i "/% %INPUT_XPDD%/r $tmp_head_pfad/robot_matlabtmp_comment_input_xPDD.m" $mfcndat
sed -i "/%INPUT_XPDD%/d" $mfcndat
