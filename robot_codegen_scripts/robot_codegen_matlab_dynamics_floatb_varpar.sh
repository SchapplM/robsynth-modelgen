...
do
  ...
  do
    ...
    quelldat=$repo_pfad/codeexport/${robot_name}_coriolisvec_base_floatb_${basemeth}_par${dynpar}_matlab.m
    ...
    quelldat=$repo_pfad/codeexport/${robot_name}_coriolismat_floatb_${basemeth}_par${dynpar}_matlab.m
    ...
    quelldat=$repo_pfad/codeexport/${robot_name}_inertia_time_derivative_floatb_${basemeth}_par${dynpar}_matlab.m
